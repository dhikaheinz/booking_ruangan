...
<html lang="en">
    <head>
        ...
        <title>Halaman Dashboard | M-ROOM PolkesJaSa</title>
        <style>
    ...
    <body class="bg-gray-100">
        ...
        <div class="md:fixed md:w-full md:top-0 md:z-20 flex-row flex-wrap items-start bg-white p-6 border-b border-gray-300">
            ...
            <div class="flex flex-row items-center justify-between">
                ...
                <strong class="capitalize ml-3 flex-1 block xl:hidden"><a href="/">M-ROOM PolkesJaSa</a></strong>
                <strong class="capitalize ml-3 flex-1 hidden xl:block"><a href="/">M-ROOM PolkesJaSa</a></strong>
                    ...
                    <div class="dropdown relative md:static">
                        <button class="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center">
                            ...
                            <div class="ml-2 capitalize flex">
                                <h1 class="text-sm text-gray-800 font-semibold m-0 p-0 leading-none"> <?php echo $this->session->userdata('nama_user'); ?> </h1>
                        ...
                        <div class="text-gray-500 menu hidden md:mt-10 md:w-full rounded bg-white shadow-md absolute z-20 right-0 w-40 mt-5 py-2 animated faster">
                            ...
                            ?>
                            ">
                                <i class="fad fa-user-times text-xs mr-1"></i> Keluar </a>
                            <!-- end item -->
                        </div>
                    </div>
                    <!-- end user -->
