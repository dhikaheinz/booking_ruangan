...
<div class="h-screen flex flex-row flex-wrap">
    ...
    <div class="bg-gray-100 flex-1 flex-row p-6 md:mt-24">
        ...
        <div class="flex flex-row justify-start">
            <div>
                <button id="btnInputRuangan" onclick="popUpInputRuangan()" type="button" class="hidden text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 
                    font-medium rounded-lg text-sm w-full px-5 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit Request Ruangan</button>
            </div>
        </div>
        <div id="forminputRuangan" class="w-96 md:w-full">
            <h1 class="text-2xl">Edit Request Ruangan</h1><br>
                <form action="<?php echo site_url('RequestRuangan/updateRequestRuangan/').$data_request_ruangan->id_booking; ?>" method="post">
                    <div class="grid gap-5 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            dark:focus:ring-blue-500 dark:focus:border-blue-500" onfocus='this.size=5;' onblur='this.size=1;' onchange='this.size=1; this.blur();'>
                                <option value="<?= $data_request_ruangan->id_room ?>"><?= $data_request_ruangan->nama_room ?></option>
                                <?php
