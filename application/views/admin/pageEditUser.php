...
<div class="h-screen flex flex-row flex-wrap">
    ...
    <div class="bg-gray-100 flex-1 flex-row p-6 md:mt-24">
        ...
        <div id="formEditRuangan" class="w-96 md:w-full">
            ...
            <form action="<?php echo site_url('userprofil/updateUserProfil/').$data_UserProfil->nip_nim; ?>" method="post">
            <div class="grid gap-5 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        focus:border-blue-500 block w-full p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 
                        dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Tingkat" value="<?= $data_UserProfil->tingkat ?>" required>
                    </div>  
                        <div>
                            ...
                            focus:border-blue-500 block w-full p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 
                            dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Jurusan" value="<?= $data_UserProfil->jurusan ?>" required>
                        </div>
                    <div>
                        ...
                        focus:border-blue-500 block w-full p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 
                        dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan No. Hp" value="<?= $data_UserProfil->no_hp ?>" required>
                    </div>
                    <div>
                        ...
                        focus:border-blue-500 block w-full p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 
                        dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Email" value="<?= $data_UserProfil->email ?>" required>
                    </div>
                    <div>
                        ...
                        focus:border-blue-500 block w-full p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 
                        dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Password" value="<?= $data_UserProfil_Login->pass ?>">
                        <h5 class="italic text-red-500">*kosongkan bila tidak ingin mengganti password</h5>
                    </div>
                    </div>
            ...
            <div class="w-full mt-5">
                ...
                <tbody>
                <?php 
                    foreach ($viewDataUserProfil as $row) { ?>
                      <tr>
