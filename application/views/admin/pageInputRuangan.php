        ...
        <div class="flex flex-row justify-start">
            <div>
                <button id="btnInputRuangan" onclick="popUpInputRuangan()" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 
                    font-medium rounded-lg text-sm w-full px-5 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Tambah Ruangan</button>
            </div>
        </div>
        <div id="forminputRuangan" class="w-96 md:w-full hidden">
            <h1 class="text-2xl">Input Ruangan</h1><br>
                <form action="<?php echo site_url('ruangan/inputRuangan'); ?>" method="post">
                    ...
                    <div>
                        ...
                        dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Nama Ruangan" required>
                    </div>
                    <div>
                        ...
                        <input type="text" name="kuota_room" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 
                            ...
                            dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Kuota Ruangan" required>
                        </div>
                        <div>
                            ...
                            focus:border-blue-500 block w-full p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 
                            dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Gedung Ruangan" required>
                        </div>  
                        <!-- <div>
                        ...
                        <div>
                            ...
                            focus:border-blue-500 block w-full p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 
                            dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Deskripsi" required>
                        </div>
                    </div>
                      ...
                      <tr>
                        ...
                        <div class="flex flex-row my-2 gap-1">
                            <div class="pt-1 px-1 bg-blue-200 hover:bg-blue-500 text-black font-bold rounded-lg">
                                <a href="<?= site_url('ruangan/editRuangan/').$row->id_room ?>"><i class='bx bxs-edit bx-tada text-2xl' ></i></a>
                            </div>
                            <div class="pt-1 px-1 bg-orange-200 hover:bg-orange-500 text-black font-bold rounded-lg">
                                <a href="<?= site_url('ruangan/deleteRuangan/').$row->id_room ?>"><box-icon name='trash' type='solid' animation='tada' ></box-icon></a>
                            </div>
                        </div>
                        </td>
                      </tr>
